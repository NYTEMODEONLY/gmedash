      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-4 gap-4 sm:gap-0">
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
            ...
            <button
              onClick={toggleTheme}
              className="relative p-2.5 rounded-xl bg-gray-100 dark:bg-gme-dark-300 hover:bg-gray-200 dark:hover:bg-gme-dark-400 border border-gray-200 dark:border-gme-dark-400 transition-all duration-300 hover:scale-105 active:scale-95 group overflow-hidden"
            ...
            >
              <div className="relative w-5 h-5">
                ...
                {/* Moon Icon */}
                <svg
                  className={`absolute inset-0 w-5 h-5 text-slate-700 dark:text-slate-400 transition-all duration-300 ${
                    resolvedTheme === 'light'
                      ? 'rotate-0 scale-100 opacity-100'
                      : '-rotate-90 scale-0 opacity-0'
                  }`}
              ...
              <div className="absolute inset-0 rounded-xl bg-gradient-to-tr from-yellow-400/0 to-orange-400/0 group-hover:from-yellow-400/10 group-hover:to-orange-400/10 dark:group-hover:from-yellow-400/20 dark:group-hover:to-orange-400/20 transition-all duration-300" />
            </button>
            ...
            {homeHref ? (
              <Link
                href={homeHref}
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-gme-red hover:bg-gme-red-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gme-red transition-all shadow-lg hover:shadow-gme-red/25"
              >
                {homeLabel}
              </Link>
            ) : (
